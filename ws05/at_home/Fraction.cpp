...
namespace sict {
  ...
  bool Fraction::operator==(const Fraction& b) const {
    if (!this->isEmpty() && !b.isEmpty() && (this->numerator / this->denominator) == (b.numerator / b.denominator)) {
      return true;
    }
    else {
      return false;
  ...
  bool Fraction::operator!=(const Fraction& c) const {
    if (!this->isEmpty() && !c.isEmpty() && (this->numerator / this->denominator) != (c.numerator / c.denominator)) {
      return true;
    }
    else {
      return false;
